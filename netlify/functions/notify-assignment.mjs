...
const FROM_EMAIL = process.env.NOTIFY_FROM_EMAIL || 'Creative Studio Planning <notificaties@resend.dev>';
...
export default async (req) => {
  ...
  try {
    ...
    const html = `
      ...
      <p>${assignerNaam ? escapeHtml(assignerNaam) + ' heeft je' : 'Je bent'} toegewezen aan een taak buiten je eigen project in Creative Studio Planning:</p>
